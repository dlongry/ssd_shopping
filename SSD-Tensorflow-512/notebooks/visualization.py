...
def plt_bboxes_cv(fig, img, classes, scores, bboxes, figsize=(10,10), linewidth=3):
    """Visualize bounding boxes. Largely inspired by SSD-MXNET!
    """
    #fig = plt.figure(figsize=figsize)
    height = img.shape[0]
    ...
    for i in range(classes.shape[0]):
        ...
        if cls_id >= 0:
            ...
            # cv2.putTe
            cv2.putText(img, '{:s} | {:.3f}'.format(class_name, score), (xmin, ymin + 15), font, 0.8, (0,255,0), 1, False)
